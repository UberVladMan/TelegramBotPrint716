...
public class ChatBot extends TelegramLongPollingBot {
    ...
    private SendMessage SendMessage(String first_name, String last_name, String user_id, String user_username) {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        if (update.hasMessage() && update.getMessage().hasText()) {
            ...
            SendMessage(last_name, first_name, Long.toString(user_id), user_username);

            if (update.hasMessage() && update.getMessage().hasText()) {
                if (update.getMessage().getText().equals("Зробити замовлення")) {
                    try {
                        execute(message);
                        execute(SendMessage(last_name, first_name, Long.toString(user_id), user_username));
                    } catch (TelegramApiException e) {
                        e.printStackTrace();
                    }
                }
